#!/bin/bash -l
#SBATCH --job-name="c_bqp_compare"
#SBATCH --array=1-20              # 20 tasks (10 BART-BO + 10 Penalty-GA)
...
mkdir -p c_bqp_results

# Run worker script with array task ID
srun /home/people/20204013/r450/bin/Rscript c_bqp_worker100.R $SLURM_ARRAY_TASK_ID
